...
<template>
    ...
    <DocumentPopup ref="createPopup" :dossier=" {id: dossier.id, type: dossier.client.type} " :create="true" @update-documents="getDocuments"/>
</template>
...
<script>
    export default {
        ...
        mounted() {
            //is on create
            this.create = useRoute().path == '/dossier/add'
